...
typedef struct liste_s
{
  ...
  int (*comparer)(const void * n1 , const void * n2)  ; /*!< Fonction de comparaison de 2 elements */
} liste_t ;
...
extern booleen_t liste_rechercher( int * result , /* Indice de l'element trouve (-1 si pas trouve) */ 
				   liste_t * liste  ,	                        /* Liste de recherche */
				   void * element   ) ; /* Element a rechercher */

extern
booleen_t liste_supprimer( liste_t * liste , /* Liste de recherche */
			   void * const elem ) ; /* Element a supprimer  */
